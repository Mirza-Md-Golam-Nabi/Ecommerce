                ...
                <div class="col-md-8 ">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            @include('msg')
                            <form class="form-horizontal" enctype="multipart/form-data" role="form" method="POST" action="{{ route('productupload') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('products') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="products" type="text" class="form-control" name="products" value="{{ old('products') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('customerprice') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="customerprice" type="text" class="form-control" name="customerprice"  value="{{ old('customerprice') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('customerprice') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="maxcommission" type="text" class="form-control" name="maxcommission"  value="{{ old('maxcommission') }}" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('sizenm') ? ' has-error' : '' }}">
                                        <label for="sizenm" class="col-md-4 control-label">Size</label>
                                            ...
                                            <input id="sizenm" type="text" class="form-control" name="sizenm" value="{{ old('sizenm') }}" required autofocus>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group{{ $errors->has('colornm') ? ' has-error' : '' }}">
                                        <label for="colornm" class="col-md-4 control-label">Color</label>
                                            ...
                                            <input id="colornm" type="text" class="form-control" name="colornm" value="{{ old('colornm') }}" required autofocus>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group{{ $errors->has('unitenm') ? ' has-error' : '' }}">
                                        <label for="unitenm" class="col-md-4 control-label">Unite</label>
                                            ...
                                            <input id="unitenm" type="text" class="form-control" name="unitenm" value="{{ old('unitenm') }}" required autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" name="productdetl" id="productdetl" rows="5" placeholder="" required></textarea>
