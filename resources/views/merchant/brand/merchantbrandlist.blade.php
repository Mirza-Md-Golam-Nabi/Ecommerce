            ...
            <table class="table table-striped">
              ...
              <?php $i++; ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('brandEdit', $brand->id) }}"><i class="fa fa-pencil"></i></a>
                    <a onclick="return confirm('Are you sure to delete it');" href="{{ route("brandDelete", $brand->id) }}"><i class="fa fa-trash-o"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
                    ...
                    <div class="row">                       
                      ...
                      <div class="col-sm-5 text-center"> <a href="#." class="heart"><i class="fa fa-heart"></i></a> <a href="#." class="heart navi"><i class="fa fa-navicon"></i></a>
                        <div class="position-center-center">
                          ...
                          <a href="#." class="btn-round"><i class="icon-basket-loaded"></i> EDIT</a> </div>
                      </div>
                    </div>
                  </div>
                </article>
